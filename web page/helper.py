...
# def medal_tally(df1):
#     medal_tally = df1.drop_duplicates(subset = ['Team','NOC','Games','Year','Season','City','Sport','Event','Medal'])
...
# def country_years_list(df2):
#     years = df2['Year'].unique().tolist()
#     years.sort()
#     years.insert(0,'Overall')

#     country = np.unique(df2['region'].dropna().values).tolist()
#     country.sort()
#     country.insert(0,'Overall')
